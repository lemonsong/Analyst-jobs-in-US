!function(){
	var bP={};	
	var b=30, bb=150, height=600, buffMargin=1, minHeight=10;
	var c1=[-260, 40], c2=[-50, 100], c3=[-10, 140]; //Column positions of labels.
	var colors =["#FF530D", "#E82C0C", "#FF0000","#E80C7A", "#FF0DFF",
	             "#FF03A8","#D503E8","#A70AFF","#5803E8","#1C03FF",
	             "#3401FF","#0112E8","#0E5FFF","#018BE8","#01DBFF",
	             "#01FFCE","#0DFF48","#66FF01","#9AFF08","#FFEA04",
	             "#FFB908","#E8720C"];
	...
	function drawPart(data, id, p){
		...
		mainbar.append("text").attr("class","barvalue")
			.attr("x", c2[p]+4).attr("y",function(d){ return d.middle+5;})
	...
	function drawHeader(header, id){
		d3.select("#"+id).append("g").attr("class","header").append("text").text(header[2])
			...
			.style('font-family',"‘Metrophobic’, Arial, serif").style('font-weight',400);
		...
		data.forEach(function(biP,s){
			...
			[0,1].forEach(function(p){			
				d3.select("#"+biP.id)
					...
					.select(".mainbars")
					.selectAll(".mainbar")
					.on("dblclick",function(d, i){ return bP.selectSegment(data, p, i); })
